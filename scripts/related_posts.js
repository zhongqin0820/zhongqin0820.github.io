/**
 * Created by Zoking on 2019/5/3.
 */
'use strict';
hexo.extend.helper.register('related_posts', function(currentPost, allPosts){
    var relatedPosts = [];
    if (currentPost.tags == undefined || currentPost.title == '') {
    ...
    var result = '<header class="article-header"><h1 class="thumb" itemprop="name"> 相关文章</h1></header><ul class="related-posts">';
