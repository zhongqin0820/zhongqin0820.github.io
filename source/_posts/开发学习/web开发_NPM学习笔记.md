...
我们也可以<strong>把文件夹封装为一个模块，即所谓的包</strong>。<strong>包通常是一些模块的集合，在模块的基础上提供了更高层的抽象，相当于提供了一些固定接口的函数库</strong>。通过定制 `package.json`，我们可以创建更复杂，更完善，更符合规范的包用于发布。
